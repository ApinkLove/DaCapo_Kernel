/*
 * drivers/cpufreq/cpufreq_naeunburning.c
 *
 ...
 *
 * Author: Erasmux 
 * Edited by Naeunbaragy
 *
 * Smartass2 Based on the interactive governor By Mike Chan (mike@android.com)
 * which was adaptated to 2.6.29 kernel by Nadlabak (pavel@doshaska.net)
 * Based on the Smartass2 gov
 *
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_NAEUNBURNING
static
#endif
struct cpufreq_governor cpufreq_gov_naeunburning = {
	.name = "NaeunBurning",
...
static int __init cpufreq_smartass_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_naeunburning);
}

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_NAEUNBURNING
...
{
	cpufreq_unregister_governor(&cpufreq_gov_naeunburning);
...
MODULE_AUTHOR ("naeunbaragy");
MODULE_DESCRIPTION ("'cpufreq_naeunburning' - A smart cpufreq governor");
MODULE_LICENSE ("GPL");
