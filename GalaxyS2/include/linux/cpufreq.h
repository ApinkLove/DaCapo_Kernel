...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_NAEUNBURNING)
extern struct cpufreq_governor cpufreq_gov_naeunburning;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_naeunburning)
#endif
